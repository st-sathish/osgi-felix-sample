...
import static com.sathish.util.data.Collections.appendTo;
import static com.sathish.util.data.Collections.appendToA;
import static com.sathish.util.data.Collections.appendToM;
import static com.sathish.util.data.Collections.forc;
import static com.sathish.util.data.Collections.iterator;
import static com.sathish.util.data.Collections.list;
import static com.sathish.util.data.Collections.toList;
import static com.sathish.util.data.Option.none;
import static com.sathish.util.data.Option.some;
import static com.sathish.util.data.Prelude.unexhaustiveMatch;
