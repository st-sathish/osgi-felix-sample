...
import static com.sathish.util.data.Either.left;
import static com.sathish.util.data.Either.right;
import static com.sathish.util.data.Monadics.mlist;
import static com.sathish.util.data.Option.option;

import com.sathish.util.data.Effect;
import com.sathish.util.data.Effect0;
import com.sathish.util.data.Effect2;
...
import com.sathish.util.data.Predicate;
import com.sathish.util.data.Tuple;
