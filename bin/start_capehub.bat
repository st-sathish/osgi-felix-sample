...
SET FELIX_HOME=F:\e-drive\osgi\workspace\base
...
SET SATHISH_LOGDIR=%FELIX_HOME%\logs
...
pushd "%FELIX_HOME%"
java %DEBUG_OPTS% %FELIX_OPTS% %FELIX_CONFIG_OPTS% %GRAPHICS_OPTS% %MAVEN_ARG% %FELIX_FILEINSTALL_OPTS% %JMX_OPTS% -jar "%FELIX_HOME%\bin\felix.jar" "%FELIX_CACHE%"
popd
